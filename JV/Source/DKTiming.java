...
public class DKTiming extends JFrame implements ActionListener{
	Customer l;
	...
	DKTiming(){
		...
		JButton b1= new JButton("12:00 A.M.");
		JButton b2= new JButton("5:00 P.M.");
