...
public class Route extends JFrame implements ActionListener{
	Customer l;
	String[] o= {"Dhaka","Chittagong","Khulna"}; 
	...
	Route(Customer x){
		...
		JButton b1= new JButton("Dhaka to Chittagong");
		JButton b2= new JButton("Dhaka to Khulna");
		...
		b3.addActionListener(
			new ActionListener() {
				...
				f1.setVisible(false);
				CustomerLogin t=new CustomerLogin(l);
            }
         }
	    );
		...
		Label l1=new Label("Select Route ");
